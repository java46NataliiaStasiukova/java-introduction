...
private static String ipOctetRegex() {  //octet -> number in range[0-255]
...
public static String ipV4Regex() {
	...
	return String.format("((%s)\\.){3}(%s)", ipOctetRegex(), ipOctetRegex()); // same as:
 ...
 * operand: either java variable or integer number or double number,
 * for example: a; __; 10; 10.2; 10.0
 * assumption: placing of parentheses is not considered 
 * a + (10 * 2) => a+10*2
 * a + (10 * )2 => a+10*2 according to assumption
 * a + (-10 * 2) => wrong (unary operation)
 */
